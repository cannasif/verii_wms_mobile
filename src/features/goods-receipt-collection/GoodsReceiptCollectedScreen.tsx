...
export function GoodsReceiptCollectedScreen({ headerId }: { headerId: number }): React.ReactElement {
  ...
  return (
    <ScrollView contentContainerStyle={styles.content}>
      ...
      <View style={[styles.hero, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}>
        <Text style={[styles.heroEyebrow, { color: theme.colors.accent }]}>{t('goodsReceiptCollection.collectedTitle')}</Text>
        <Text style={styles.title}>{t('goodsReceiptCollection.collectedSubtitle', { id: headerId })}</Text>
      </View>
      ...
      <View style={[styles.card, { backgroundColor: theme.colors.surfaceStrong, borderColor: theme.colors.border }]}>
        {collectedQuery.isLoading ? (
          ...
          <View style={styles.centered}>
            <Text style={[styles.emptyText, { color: theme.colors.textSecondary }]}>{t('goodsReceiptCollection.noCollected')}</Text>
          </View>
        ) : (
          rows.map((row) => (
